...
## IMMUTABLE - Pre-Writing Destination Check

BEFORE writing any paper, article, or document, you MUST:

1. **Ask about publication destination**: "Where will this be published?"
   - If Medium, blog platform, or publication site → Output plain text ONLY
   - If internal docs, GitHub, or technical documentation → Markdown is acceptable
   - If unclear → Ask before proceeding

2. **Output format based on destination**:
   - **Medium/blogs**: Plain text only. Headers as standalone lines. NO markdown syntax.
     The user will format in the WYSIWYG editor.
   - **GitHub/internal**: Markdown formatting is acceptable.

3. **This check MUST happen BEFORE writing begins, not after.**
   Writing in the wrong format wastes significant effort.

**Why this matters**: Medium is WYSIWYG. Markdown syntax like ## or **bold** appears
as literal characters, not formatting. A markdown document requires complete rewriting
...
---
**Status**: Active Specialized Protocol - v1.3.0`
};
